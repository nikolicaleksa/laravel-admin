        ...
        <form id="add-post-form" class="form-horizontal" method="POST" action="{{ route('addPost') }}" role="form">
            ...
            <div class="form-group">
                ...
                <div id="description_div" class="col-xs-10">
                    <input type="text" name="description" id="description" class="form-control" placeholder="@lang('content.posts.description')" tabindex="2">
            ...
            <div class="form-group">
                ...
                <div id="keywords_div" class="col-xs-10">
                    <input type="text" name="keywords" id="keywords" class="form-control tagsinput" tabindex="3">
            ...
            <div class="form-group">
                ...
                <div id="content_div" class="col-xs-10">
                    <textarea name="content" id="content" class="form-control editor" placeholder="@lang('content.posts.content')" tabindex="4"></textarea>
            ...
            <div class="form-group">
                ...
                <div id="category_id_div" class="col-xs-10">
                    <select name="category_id" class="form-control" id="category_id" tabindex="6">
            ...
            <div class="form-group">
                ...
                <div id="publish_option_div" class="col-xs-10">
