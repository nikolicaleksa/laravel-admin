                ...
                <div class="col-lg-9 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div id="content_div" class="col-xs-11">
                            <textarea name="content" id="content" class="form-control editor" placeholder="@lang('content.posts.content')" tabindex="2">
                                {{ $post->content }}
                            </textarea>
                            ...
                            <div class="panel-body post-data">
                                <div class="form-group">
                                    ...
                                    <div id="description_div" class="col-xs-12">
                                        <textarea name="description" id="description" class="form-control" placeholder="@lang('content.posts.description')" tabindex="3" rows="5">{{ $post->description }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="keywords_div" class="col-xs-12">
                                        <input type="text" name="keywords" id="keywords" class="form-control tagsinput" value="{{ $post->keywords }}" tabindex="4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="category_id_div" class="col-xs-12">
                                        <select name="category_id" class="form-control" id="category_id" tabindex="5">
                                            <option disabled value="">@lang('content.posts.select-category')</option>
                            ...
                            <div class="panel-body">
                                    ...
                                    <div id="publish_option_div" class="col-xs-12">
                                        <select name="publish_option" class="form-control" id="publish_option" tabindex="7">
                                            ...
                                            @foreach($publishOptions as $publishOption)
                                                <option value="{{ $publishOption }}" @if($post->getPublishOption() == $publishOption) selected @endif>@lang('content.posts.publish-options-list.' . $publishOption)</option>
                                            @endforeach
                                        </select>
                                ...
                                <div id="published_at_parent" class="form-group @if(!$post->isScheduled()) hidden @endif">
                                    ...
                                    <div id="published_at_div" class="col-xs-12">
                                        <input type="text" name="published_at" id="published_at" class="form-control" value="{{ $post->published_at }}" readonly tabindex="8">
