...
<div class="container">
    <div class="page-header">
        <h1 class="h2">@lang('content.comments.unapproved-comments-title')</h1>
        <span>@lang('content.comments.unapproved-comments-description')</span>
    </div>
    <div class="text-right add-entry">
        <a class="btn btn-sm btn-success" href="{{ route('showApprovedCommentsList') }}" title="@lang('content.comments.approved-comments-button')">
            <i class="fa fa-comments"></i> @lang('content.comments.approved-comments-button')
        </a>
    </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content text-left">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-success approve-comment" data-comment-id="{{ $comment->id }}" data-approve-url="{{ route('approveComment', ['comment' => htmlspecialchars($comment->id)]) }}">
                                        @lang('content.comments.approve-comment-button')
                                    </button>
    ...
    @else
        <div class="alert alert-danger text-center" role="alert">
            <i class="fa fa-warning"></i> @lang('messages.comments.no-unapproved-comments')
        </div>
    @endif
</div>
@endsection